/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 21c6a39c0ca9f62c3918de591ef5dfb3)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	PIKO: KVNamespace;
	PIKO_DEVICE_TOKEN: string;
	RAISES_SIGNING_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PIKO_DEVICE_TOKEN" | "RAISES_SIGNING_SECRET">> {}
}
